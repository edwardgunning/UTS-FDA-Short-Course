...
*__Note:__ This course was originally designed for ISBS 2024 with [Prof. Drew Harrison (University of Limerick)](https://www.ul.ie/shprc/professor-drew-harrison). You can check out the original website [here](https://github.com/edwardgunning/ISBS-Short-Course/tree/main).*
...
* Queries about the course material should be sent to [edward.gunning@pennmedicine.upenn.edu](mailto:edward.gunning@pennmedicine.upenn.edu) with the subject line *"UTS FDA workshop material"*.
